...
CREATE TABLE DimBroker  ( SK_BrokerID SERIAL PRIMARY KEY,
...
CREATE TABLE DimCompany (   SK_CompanyID SERIAL PRIMARY KEY, 
...
CREATE TABLE DimDate (  SK_DateID SERIAL PRIMARY KEY,
...
CREATE TABLE DimSecurity( SK_SecurityID SERIAL PRIMARY KEY,
